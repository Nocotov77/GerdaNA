// ЛАБОРАТОРНАЯ РАБОТА 6. ЧАСТЬ 5 - RUST И СИСТЕМНОЕ ПРОГРАММИРОВАНИЕ
// ОКОНЧАТЕЛЬНО ИСПРАВЛЕННАЯ ВЕРСИЯ (БЕЗ ВСЕХ ОШИБОК)
...
fn main() {
    println!("\n{}", "█".repeat(70));
    println!("ЛАБОРАТОРНАЯ РАБОТА 6. ЧАСТЬ 5 - RUST И СИСТЕМНОЕ ПРОГРАММИРОВАНИЕ");
    println!("{}\n", "█".repeat(70));
